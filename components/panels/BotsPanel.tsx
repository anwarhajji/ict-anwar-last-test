...
export const BotsPanel: React.FC = () => {
    ...
    const [customStrategies, setCustomStrategies] = useState([
        { id: 'strat_custom_1', name: 'My Custom EMA', code: 'function onTick(market, position) {\n  // Exemple de code JavaScript\n  if (market.price > market.ema20 && !position) {\n    return { action: "BUY", size: 1.0 };\n  }\n  if (market.price < market.ema20 && position) {\n    return { action: "CLOSE" };\n  }\n  return null;\n}' }
    ]);
    ...
    return (
        <div className="h-full bg-[#0b0e11] text-white p-6 overflow-y-auto relative">
            <div className="max-w-6xl mx-auto space-y-8">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <optgroup label="Built-in Models">
                                            ...
                                            <option value="London Breakout v2.0">London Breakout v2.0</option>
                                            <option value="2022 Mentorship Model">2022 Mentorship Model</option>
                                        </optgroup>
                ...
                {showStrategyModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                        <div className="bg-[#151924] border border-[#2a2e39] rounded-xl w-full max-w-3xl overflow-hidden shadow-2xl flex flex-col h-[80vh]">
                            <div className="p-4 border-b border-[#2a2e39] flex justify-between items-center bg-[#0b0e11] shrink-0">
                                ...
                                <button onClick={() => setShowStrategyModal(false)} className="text-gray-400 hover:text-white">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                                </button>
                            </div>
                            <form onSubmit={handleSaveStrategy} className="flex flex-col flex-1 overflow-hidden">
                                ...
                                <div className="flex-1 p-4 flex flex-col bg-[#0b0e11]">
                                    ...
                                    <div className="text-xs text-gray-400 mb-3 bg-[#151924] p-3 rounded-lg border border-[#2a2e39] grid grid-cols-3 gap-4">
                                        <div>
